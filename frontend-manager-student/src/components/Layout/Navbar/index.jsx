  ...
  return (
    <div className="top-navbar">
      <nav className="navbar navbar-expand-lg navbar-light p-0">
        <div className="menu-bt d-flex align-items-center">
          ...
          <ul className="navbar-nav ml-auto navbar-list">
            <li className="nav-item nav-icon search-content">
              <a href="giabao" className="search-toggle waves-effect text-gray rounded">
                <span className="ripple rippleEffect" style={{ width: 35, height: 35, top: 3, left: -2.65002 }}></span>
                <i className="fal fa-search"></i>
              </a>
            ...
            <li className={`nav-item nav-icon ${showTab === 1 ? 'iq-show' : ''}`} onClick={(e) => selectTab(e, 1)}>
              <a href="itc.edu.vn" className="search-toggle waves-effect text-gray rounded">
                <span className="ripple rippleEffect" style={{ width: 35, height: 35, top: -3, left: 0.349976 }}></span>
